    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-text-dark">Explorer les cabinets partenaires</h2>
          ...
          {cabinets.map((cabinet) => (
            <Card key={cabinet.id} className="flex flex-col">
              <div className="flex items-start gap-3 mb-4">
                <div className="w-10 h-10 bg-blue-light text-blue-royal rounded-full flex items-center justify-center font-bold">
                  {cabinet.nom.charAt(0)}
                </div>
                <div>
                  <h3 className="font-semibold text-text-dark">{cabinet.nom}</h3>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {cabinet.specialites.map((spec) => (
                  <span key={spec} className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium bg-blue-light text-blue-dark rounded-full">
        ...
        <div className="mt-16 bg-blue-royal rounded-2xl p-8 text-center text-white">
          ...
          <Button href="/espace-cabinet" className="bg-white text-blue-royal hover:bg-blue-50">
